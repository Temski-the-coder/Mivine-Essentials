      ...
      <div className="w-full h-[400px] md:h-[400px] lg:h-[600px] relative">
        ...
        <div className="absolute inset-0 bg-black/5 flex items-center justify-center pointer-events-none z-20">
          <div className="text-center text-white/85 p-6 mt-30 pointer-events-auto w-full">
            ...
            <p className="flex-col md:flex sm:mb-1 mt-22 hero-text items-center justify-center text-lg gap-2 text-gray-100 w-full">
              Your refined summer style awaits
              <FaLongArrowAltRight className="hidden md:visible"/>
              <Link
                to="/collections/all"
                className="bg-black text-white w-fit md:w-full px-2 md:px-3 py-1 flex rounded-none md:rounded-full text-lg sm:text-sm justify-center hover:bg-black hover:text-white"
              >
                Shop the Heat
              </Link>
            </p>
